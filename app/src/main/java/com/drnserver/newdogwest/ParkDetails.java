...
public class ParkDetails extends AppCompatActivity implements OnMapReadyCallback{
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(ParkDetails.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
